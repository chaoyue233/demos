...
public class RSAUtilV2 {
     ...
     * 用来指定保存密钥对的文件名和存储的名称
     */
    private static final String PUBLIC_KEY_NAME = "chaoyue_publicKey";
    private static final String PRIVATE_KEY_NAME = "chaoyue_privateKey";
    ...
    public static void main(String[] args) {
        String s = "{\"userId\":\"chaoyue\",\"time\":1,\"deviceId\":\"123123\"}";
        String publicKey = "chaoyue_key_public";
        String privateKey = "chaoyue_key_private";
